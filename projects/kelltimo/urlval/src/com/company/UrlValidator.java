 ...
 * <pre>
 *   Example of usage:
 *   Construct a com.company.UrlValidator with valid schemes of "http", and "https".
 *
 *    String[] schemes = {"http","https"}.
 *    com.company.UrlValidator urlValidator = new com.company.UrlValidator(schemes);
 ...
 *
 *    com.company.UrlValidator urlValidator = new com.company.UrlValidator();
 *    if (urlValidator.isValid("ftp://foo.bar.com/")) {
 *       System.out.println("url is valid");
 *    } else {
 *       System.out.println("url is invalid");
...
public class UrlValidator implements Serializable {
   ...
   private static final String[] DEFAULT_SCHEMES = {"http", "https", "ftp"}; // Must be lower-case
    ...
    /**
     * Create a com.company.UrlValidator with default properties.
     */
    public UrlValidator() {
        this(null);
    }
    ...
    /**
     * Initialize a com.company.UrlValidator with the given validation options.
     ...
     * Note: this implementation validates the domain unless a com.company.RegexValidator was provided.
     * If a com.company.RegexValidator was supplied and it matches, then the authority is regarded
     * as valid with no further checks, otherwise the method checks against the
     * AUTHORITY_PATTERN and the com.company.DomainValidator (ALLOW_LOCAL_URLS)
