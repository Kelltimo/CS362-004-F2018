...
public class DomainValidator implements Serializable {
    ...
    /**
     * com.company.RegexValidator for matching domains.
     */
    private final RegexValidator domainRegex =
            new RegexValidator(DOMAIN_NAME_REGEX);
    /**
     * com.company.RegexValidator for matching a local hostname
     */
    // RFC1123 sec 2.1 allows hostnames to start with a digit
...
//        "tp",                 // East Timor (Retired)
     ...
     * For example:
     * <p>
     * {@code com.company.DomainValidator.updateTLDOverride(ArrayType.GENERIC_PLUS, new String[]{"apache"})}
     * <p>
     ...
     */
    // Needed by com.company.UrlValidator
